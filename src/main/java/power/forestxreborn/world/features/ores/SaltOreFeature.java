...
public class SaltOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("forest:rock_salt", FEATURE,
				new OreConfiguration(SaltOreFeatureRuleTest.INSTANCE, ForestModBlocks.ROCK_SALT.get().defaultBlockState(), 12));
		PLACED_FEATURE = PlacementUtils.register("forest:rock_salt", CONFIGURED_FEATURE, List.of(CountPlacement.of(20), InSquarePlacement.spread(),
	...
	public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("forest:burned_forest"));
	...
	private static class SaltOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("forest:rock_salt_match"), CUSTOM_MATCH);
		}
