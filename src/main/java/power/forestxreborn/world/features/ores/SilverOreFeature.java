...
public class SilverOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("forest:silver_ore", FEATURE,
				new OreConfiguration(SilverOreFeatureRuleTest.INSTANCE, ForestModBlocks.SILVER_ORE.get().defaultBlockState(), 8));
		PLACED_FEATURE = PlacementUtils.register("forest:silver_ore", CONFIGURED_FEATURE, List.of(CountPlacement.of(3), InSquarePlacement.spread(),
	...
	private static class SilverOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("forest:silver_ore_match"), CUSTOM_MATCH);
		}
