...
public class DeepslateSilverOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("forest:deepslate_silver_ore", FEATURE,
				new OreConfiguration(DeepslateSilverOreFeatureRuleTest.INSTANCE, ForestModBlocks.DEEPSLATE_SILVER_ORE.get().defaultBlockState(), 8));
		PLACED_FEATURE = PlacementUtils.register("forest:deepslate_silver_ore", CONFIGURED_FEATURE,
	...
	private static class DeepslateSilverOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("forest:deepslate_silver_ore_match"), CUSTOM_MATCH);
		}
